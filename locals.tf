...
locals {
  alz_policy_assignments_decoded     = var.skip_policy_assignments == true ? {} : { for k in data.alz_archetype_keys.this.alz_policy_assignment_keys : k => jsondecode(data.alz_archetype.this.alz_policy_assignments[k]) }
...
locals {
  policy_role_assignments = data.alz_archetype.this.alz_policy_role_assignments != null && var.skip_policy_assignments == false ? {
